    ...
    vec![
        ...
        tool_def(
            ...
            &[
                ...
                ("semantic_embedding", "boolean", false),
                ("embedding_threshold", "number", false),
                ("embedding_top_per_gap", "number", false),
            ],
        ),
        tool_def(
            "analyze_change",
